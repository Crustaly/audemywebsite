<template>
  <div
    ...
    :class="[isTablet || isMobile ? 'bg-[#FAE9B6]' : 'bg-[#FAE9B6]']"
  >
    <!-- Header -->
    <div class="w-full">
      <GamePagesHeader />
          ...
          <div class="flex flex-col justify-center items-center mb-8">
            ...
            <div class="text-center">
              <h1
                :class="[
                  isMobile
                    ? 'w-[350px] h-[60px] text-[56px] leading-[60px]'
                    : 'w-[397px] h-[70px] text-[64px] leading-[70px]',
                ]"
...
const toggleRecording = () => {
  if (numOfAudiosPlayed.value < 5 && !isIntroPlaying.value) {
    if (!isListening.value) {
      ...
      // Delay of 1 second before stopping recording
      setTimeout(() => {
        stopListening();
        isListening.value = false;
        isRecording.value = false;
