<template>
  <div
    ...
    :class="[isTablet || isMobile ? 'bg-[#FFD2F4]' : 'bg-[#FFD2F4]']"
  >
    <!-- Header -->
    <div class="w-full">
      <GamePagesHeader />
        ...
        >
          ...
          <div class="flex flex-col justify-center items-center mb-8">
            ...
            <div class="flex flex-col items-center">
              <div class="mb-2">
                <img
                  src="/assets/gameImages/buttons/gameButtons/oddOneOut.svg"
                  alt=""
                  class="w-[70px] h-[70px]"
                />
              </div>
...
import GamePagesHeader from "../../Header/GamePagesHeader.vue"; // Added missing import
...
const repeatQuestion = () => {
  if (
    ...
    // Delay of 5 seconds before resetting cooldown
    setTimeout(() => {
...
const toggleRecording = () => {
  if (numOfAudiosPlayed.value < 5 && !isIntroPlaying.value) {
    if (!isRecording.value) {
      ...
      // Delay of 1 second before stopping the recording
      setTimeout(() => {
        stopListening();
        isRecording.value = false;
        isButtonCooldown.value = false;
