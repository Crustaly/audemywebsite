      ...
      <div class="max-w-[509px] mb-12">
        ...
        >
          ...
          <span style="color: #077bb3" class="font-semibold"
            >Carl the Caterpillar</span
          >
        </h2>
        <p class="text-body text-xl font-poppins leading-8">
          Say hello to our
          <strong> smallest, yet most important teammate</strong>! Carl is on a
          mission to become a beautiful butterfly—but before he can spread his
          wings, he needs to master math, science, and spelling.
          <em style="color: #fe892a"
            >He can’t do it alone... Carl needs children to help him
            succeed!</em
          >
        </p>

        <p class="text-body text-xl font-poppins leading-8">
          <strong> Join Carl’s adventure and help him grow!</strong>
        </p>
      </div>
    </div>
  </div>
