  ...
  >
    ...
    <div class="w-1/2">
      ...
      <div class="max-w-[509px] mb-12">
        ...
        >
          Meet Carl the Caterpillar
        </h2>
        <p class="text-body text-xl font-poppins leading-8">
          Introducing our smallest but most important team member! Carl is on a
          journey to become a beautiful butterfly, but he must first learn math
          and spelling. He needs children's help to succeed!
        </p>
      </div>
    </div>
  </div>
