  ...
  >
    ...
    >
      ...
      >
        ...
        >
          <h1 class="text-[36px] mobile:text-[24px]">
        ...
        <div class="w-7/12 max-w-[450px]">
          <div class="mb-[16px]">
            <label class="block text-[#0C0D0D] mb-1 font-semiBold" for="email"
              >Email Address</label
            >
            <input
              v-model="email"
          ...
          <div class="mb-3" v-if="errors">
            <div class="text-red-700" role="alert">
              <span class="block sm:inline"
                >No account found with that email address.</span
              >
            </div>
          </div>
          <div class="flex justify-start w-full">
            <h5>
              Return to
              <a href="./login" class="underline text-[#087BB4] font-medium"
                >Log in</a
              >
            </h5>
          </div>
